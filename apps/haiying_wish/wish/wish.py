...
class Wish(object):
    ...
    def _headers(self):
        headers = {
            ...
            # 'cookie': self.cookie(),
            'cookie': f'bsid=228aa40b6b0d41148887b3d591058ba0;_fbp=fb.1.1626772165936.386786848;visitor_id=d016a45881094c2da3096f508b53e489;tatari-cookie-test=52228233;logged_out_tracker=7a9c054d77ca8ac18f76ff6992f4bb5820d232afa1ca6447afcfc2487260b9e7;_gid=GA1.2.1881824203.1626772165;_ga=GA1.2.1102781720.1626772165;tatari-session-cookie=026b910d-95f2-3c2a-ff6c-326d77a7fa26;__ssid=cef7777054d95990c255189ef3cb65d;_uetsid=2de106b0e93a11ebb9f3e92c0fe2b9c0;_uetvid=2de169c0e93a11eb8afa770f5b78c196;G_ENABLED_IDPS=google;logged_out_locale=en;_xsrf=2|3f76f050|36813ca7a8c3018e964b627cc30e932b|1626774685'
    ...
    def crawl_wish(self, product_id):
        ...
        if data:
            ...
            logger.info(json.dumps(login_data))
